...
const LoginPage = () => {
    ...
    // Function to update state when a user types in an input field
    const handleChange = (e) => {
        const { name, value } = e.target;
        setFormData(prevState => ({ ...prevState, [name]: value }));
    };

    // Function to handle what happens when the form is submitted
    const handleSubmit = (e) => {
        e.preventDefault();
        // In a real application, this is where you would save the data.
        console.log("Cadet Profile Submitted:", formData);
        // For example, you could navigate to another page:
        // navigate('/dashboard');
    };

    // Helper function to generate random stars for the background
